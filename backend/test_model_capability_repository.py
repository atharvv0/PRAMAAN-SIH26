...
VALID_MODEL_VERSION_ID = "00000000-0000-0000-0000-000000000000"


def test_create_model_capability_invalid_capability(db):
    ...
    with pytest.raises(
        ...
        create_model_capability_service(
            db=db,
            model_version_id=VALID_MODEL_VERSION_ID,
            capability="",
            score=0.95,
        )
