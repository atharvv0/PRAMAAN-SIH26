...
Every tool call passes through PolicyEngine before execution.
    ...
    while True:
        ...
        try:
            ...
            if step.tool:
                ...
                # ---------------------------------------------------------
                # SECURITY GATE
                # Agent -> PolicyEngine -> Tool
                # Never Agent -> Tool directly.
                # ---------------------------------------------------------
                ...
                # Every decision is audited, including DENY.
                audit_log.record(
                    actor=state.user_id,
                    action="tool.invoke",
                    target=step.tool,
            ...
            # Security denial is never retried.
            break
